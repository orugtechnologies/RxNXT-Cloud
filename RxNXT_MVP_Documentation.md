...
- **Clinical Level Drug Database (Custom Drugs):** Allows clinic admins to upload a custom preferred medicine catalog via CSV bulk upload or manual entry. Custom drugs are prioritized in search results.
